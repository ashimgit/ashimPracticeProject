...
<div class="wrapper">
  ...
  <div class="top">
    ...
    <h1 style="font-size: 50px; font-family: verdana">Halder Fruit Shop</h1>
  </div>
  ...
  <ul class="navigation">
    ...
    <li><a href="#" title="Master Entry">Master Entry</a>
      <ul>
        <li><a href="fruit_master.jsp" title="Fruit">Fruit</a></li>
...
<div id="f_footer">
<label class="f_text">&copy; ashimPedia 2015</label>
</div>
</body>
</html>